/**
 * Isolated guest B: Harbor asphalt (laneM ≲ 3) must not get Phở or
 * lantern E. Sidewalk kiosk E still opens. Persist E still none.
 * Leftover Menu + panel banners hold. Does not catalog_clear.
 * NOT_PLAN_PASS.
 */
...
const OUT = join(import.meta.dirname, "J5-STALL-E-RANGE-2026-09-04.txt");
const SHOT = join(import.meta.dirname, "j5-3d-stall-e-range.png");
const PORT = Number(process.env.HH_CDP_PORT_B || 9706);
const RUN_ID = "HH3D-J5-20260904-ASIA-SAIGON-34";
...
try {
  ...
  report = {
    run_id: RUN_ID,
    player: PLAYER,
    verdict: ok ? "J5_STALL_E_RANGE_OK" : "J5_STALL_E_RANGE_FAIL",
    not_plan_pass: true,
    not_gate_u1: true,
    not_m1: true,
    liveJs,
...
if (report.verdict !== "J5_STALL_E_RANGE_OK") {
