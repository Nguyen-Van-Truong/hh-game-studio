...
class PublicationClientTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def attach(durable, **kwargs):
            ...
            publisher._state = {'phase': 'EMPTY', 'stopped': False, 'config': {
                ...
                'binary_sha256': fixture.host_module.BLENDER_SHA256}}
            ...
            return factory(durable, publication=publisher, **kwargs)
    ...
    def export_request(self):
        return self.body(command_id='Export/Public', operation='export.publish',
    ...
    def test_export_discovery_requires_exact_owned_publisher_and_registered_lease(self):
        ...
        self.assertIn('export.publish', {item.operation for item in discovered.capabilities})
