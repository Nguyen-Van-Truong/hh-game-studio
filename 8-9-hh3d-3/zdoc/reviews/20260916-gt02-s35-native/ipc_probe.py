...
RUNTIME_TEMP=tempfile.TemporaryDirectory(prefix='gt02-s35-runtime-')
...
def main():
    ...
    assert all('studio.host.core.'+name[:-3] in loaded for name in ('pipe_io.py','pipe_endpoint.py','fixture_pipe.py','transport.py','journal.py'))
