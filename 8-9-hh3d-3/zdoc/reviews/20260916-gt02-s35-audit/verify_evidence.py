...
PACK = ROOT / 'zdoc/reviews/20260916-gt02-s35-01'
STUDIO = ROOT / 'studio'
...
def verify():
    ...
    assert native['source_closure_sha256'] == closure and native['source_files'] == len(files)
    return {'schema': 'hh-gt02-coordinator-verification-v1', 'status': 'COORDINATOR_LOGIC_VERIFIED',
            ...
            'coverage': coverage, 'native_counter_integration': native,
