...
const SOURCE_PATHS: Array[String] = ["res://addons/hh_studio/plugin.gd",
    ...
    "res://project.godot", INPUT, EVIDENCE_IGNORE, "res://benchmark/s107-context.json"]
...
func _s107_dispatch(_delta: float) -> void:
...
func _finish() -> void:
    ...
    for path: String in SOURCE_PATHS:
        if FileAccess.get_sha256(path) != _source_hashes[path]:
            ...
            return
    if _s107_rows.size() != S107_RECORD_CAP or not _s107_current.is_empty():
...
const S107_BASE_SOURCE_SHA256: String = "13e65360cd0bc0033d0ad414fb3238e216b0d6dcc08e57dc7026ec4fc9eb8b95"
const S107_RECIPE_SHA256: String = "ba8cf9a2646accf7e62e0b66053dbe24381311825574478beb28142607211619"
