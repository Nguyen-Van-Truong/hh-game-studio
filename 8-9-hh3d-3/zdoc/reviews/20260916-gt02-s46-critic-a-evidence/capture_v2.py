...
report=runner.run_process([sys.executable,'-B',str(here/'review_probe_v2.py')],cwd=product,
    output=here,timeout=120,label='critic-a-v2')
(here/'capture-v2.json').write_text(json.dumps(report,indent=2)+'\n')
