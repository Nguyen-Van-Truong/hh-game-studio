...
report=runner.run_process([sys.executable,'-B',str(here/'audit_probe.py')],cwd=product,
    output=here,timeout=60,label='critic-a-audit')
(here/'capture-audit.json').write_text(json.dumps(report,indent=2)+'\n')
