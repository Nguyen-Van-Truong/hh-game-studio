...
def verify():
    ...
    native=ROOT/'zdoc/reviews/20260916-gt02-s39-native'; host=read(native/'run-01.host.json'); raw=read(native/'run-01.stdout.json')
    ...
    return {'schema':'hh-gt02-s39-coordinator-verification-v1','status':'COORDINATOR_LOGIC_VERIFIED',
