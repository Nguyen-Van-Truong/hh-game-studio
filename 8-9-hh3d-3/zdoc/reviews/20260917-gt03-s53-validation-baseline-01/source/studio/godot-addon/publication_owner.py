...
Only registered editor/validator owners can supply observations. Journal v4
...
class GodotPublicationOwner:
    ...
    def create(cls, parent: Path, *, project_id: str, initial_bundle, editor_binary: Path,
        ...
        owner.journal_model = _load('publication_journal_v4')
        ...
        try:
            ...
            owner._journal = owner.journal_model.PublicationJournalV4.create(storage_parent,
    ...
    def discover(self, body, *, authorization, catalog_digest):
        ...
        self._same_release()
        implemented = frozenset({'scene.inspect', 'scene.preview', 'scene.save', 'script_text.replace'})
