"""Every native lane must reject stale or incomplete frozen-source binding."""
import copy
import json
...
results = []
for folder, filename in ((verify.MANAGED, 'managed-native-stdout.txt'), (verify.BOUNDARY, 'native-stdout.txt'), (verify.REGISTRY, 'registry-native-stdout.txt')):
