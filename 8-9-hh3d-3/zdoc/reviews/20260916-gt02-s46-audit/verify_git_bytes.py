"""Verify frozen source and S46 evidence against an index or commit tree."""
import hashlib
import json
...
source = json.loads(git_bytes('zdoc/reviews/20260916-gt02-s46-01/source-closure.json'))
rows = []
...
checked = []
for folder in ('20260916-gt02-s46-01', '20260916-gt02-s46-audit', '20260916-gt02-s46-boundary', '20260916-gt02-s46-native', '20260916-gt02-s46-public', '20260916-gt02-s46-registry-native', '20260916-gt02-s46-selector-client', '20260916-gt02-s46-service', '20260916-gt02-s46-service-review-evidence'):
