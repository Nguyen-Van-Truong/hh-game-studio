...
def main():
    ...
    evidence = {"schema": "hh-gt02-candidate-v1", "run_id": args.run_id,
                ...
                "known_gaps": ["Managed fixture scoped discovery/client/service requires same-closure native endpoint and boundary evidence; generic arbitrary-path mutation stays unsupported",
                               "Managed terminal restart has registry custody; ambiguous pending, stopped and verified-empty restart roots remain held for explicit reconciliation",
