...
class WriteCatalogTests(unittest.TestCase):
    ...
    def test_descriptor_persistence_and_diff_claims_are_bounded(self):
        ...
        self.assertFalse(catalog.DESCRIPTOR["native_checkpoint_protected_publication"])
        for operation in catalog.WRITE_OPERATIONS:
            ...
            self.assertEqual(declaration["diff_supported"], operation in catalog.EDIT_OPERATIONS)
