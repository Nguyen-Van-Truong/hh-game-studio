...
## S150 quiescence follow-up

Fresh ID after S149-02 terminal Event23→24. At batch9 the child publishes the immediate checkpoint, then performs a bounded 250ms zero-duration scheduler yield and publishes `09-quiet`; the observer records both PSS samples. Original CommandProducer workload and gates remain unchanged. This is diagnostic-only and does not relax the retained-counter gate.
