...
REQUIRED = {
    "edit": ("actual_pinned_gui", "actual_window_event_loop", "automatic_python_disabled", "empty_owned_ui_fixture",
             ...
             "queue_deadline_no_effect", "stale_revision_rejected_no_effect", "stop_cancels_queued_no_effect",
             "stop_preserves_receipt", "native_gui_save_exact_revision", "no_public_ack", "owned_timer_unregistered"),
