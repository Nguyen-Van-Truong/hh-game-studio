"""File-only S60 fixed-profile audit; each process imports one frozen closure."""
...
HERE = ROOT / 'studio/.local/reviews/20260917-gt04-s60-file-audit' / PROFILE
HERE.mkdir(parents=True, exist_ok=True)
PACKAGE = ROOT / 'studio/.local/reviews' / ('20260917-gt04-s60-' + PROFILE + '-01')
SOURCE = PACKAGE / 'source/studio'
CLOSURE = 'f5ae5dfbb451d3204197c2b21486c586698089ac24d14d23641a9182b5e42673'
COUNT = 599 if PROFILE == 'scene' else 328
...
def verify():
    ...
    return {'passed':True,'formal_acceptance':False,'source_closure_sha256':CLOSURE,'source_files':len(manifest['files']),
        ...
        'scope':'GT04 S60 fixed-profile component integration; final matrix and two critics still pending'}
