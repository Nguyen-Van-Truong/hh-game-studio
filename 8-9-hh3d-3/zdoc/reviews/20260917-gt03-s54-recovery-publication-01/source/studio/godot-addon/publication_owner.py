...
class GodotPublicationOwner:
    ...
    def submit(self, body, *, authorization, catalog_digest):
        ...
        try:
            ...
            # Each edit needs capture+edit; save needs capture+adopt. Reject
            # before durable admission rather than fail halfway through a pair.
            _need(len(self._editor._intents) + 2 <= self.editor_model.MAX_EFFECTS,
