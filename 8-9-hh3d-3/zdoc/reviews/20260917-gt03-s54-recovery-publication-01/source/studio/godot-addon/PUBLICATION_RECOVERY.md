...
recovery events. The V4 publication prefix and optional V5 edit events retain
...
Complete authenticated publication/validation/crash/recovery, same-closure
integration and independent critics are still required. A persisted original
Stop remains stopped. An old idle Stop that existed only in RAM cannot be
reconstructed. Recovery does not roll back a selected candidate for UNKNOWN,
