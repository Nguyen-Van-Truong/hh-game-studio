...
```powershell
python 8-9-hh3d-3/studio/tests/blender/run_blender_ui_probe.py --output 8-9-hh3d-3/zdoc/reviews/20260917-gt04-ui-06
```

It freezes this complete Blender source scope, runs the 40 Python tests, then
