...
$taskName='HHStudio.GT06.gt06-s93-sparse-attribution-01'
...
Need (!(Test-Path -LiteralPath (Join-Path $studio '.local\reviews\gt06-s93-sparse-attribution-01'))) 'TASK_RUN_ID_ALREADY_USED'
...
$request=[ordered]@{schema='HH-GT06-S91-OBSERVER-REQUEST-1';run_id='gt06-s93-sparse-attribution-01';helper_files=$helperFiles;python_sha256=(Hash $python);pythonw_sha256=(Hash $pythonw);godot_sha256=$lock.godot.gui_sha256;working_directory=$studio;wall_seconds=7530;outer_process_limit=7}
