...
class EditorOwner:
    ...
    def script_observation(self):
        ...
        with self._mutex:
            ...
            expected = {'source_sha256': eligible.script.sha256, 'disk_sha256': eligible.script.sha256,
                ...
                'global_name': '', 'methods': [], 'signals': [], 'constants': [], 'can_instantiate': True,
    ...
    def _receipt(self, receipt, kind=None):
        self._healthy()
        _need(type(receipt) in (EditorCaptureReceipt, EditorAdoptionReceipt, EditorGenerationReceipt) and (kind is None or type(receipt) is kind), 'EDITOR_RECEIPT_TYPE')
