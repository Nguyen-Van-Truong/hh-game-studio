...
def validate(value):
    ...
    if type(operation) is not str or operation not in ("scene.inspect", "mesh.create_box", "object.transform.set"):
    ...
    if operation == "scene.inspect":
        ...
        fields = ("object_id", "size") if operation == "mesh.create_box" else ("object_id", "location", "rotation", "scale")
