...
class SparseProbe:
    ...
    var _batch: int = 4
    var _input: Dictionary = {"run_id": "gt06-s91-sparse-smoke-01"}
...
func _run() -> void:
    ...
    var status: Dictionary = {"schema_id": "hh-studio.gt06.s91-controlled-smoke", "schema_version": "1.0.0",
        "run_id": "gt06-s91-sparse-smoke-01", "helper_sha256": "0837a4a6d21715c3706ce376750dc2f28ebae7f4f214f2988b4ea90a71a25281", "passed": passed,
