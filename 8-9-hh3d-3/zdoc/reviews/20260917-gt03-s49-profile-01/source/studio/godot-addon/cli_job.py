...
class Owner:
    ...
    def _failure(self, operation, error):
        ...
        if self._handle is not None:
            _hold(self)
        return JobError('CLI_JOB_' + operation + '_UNCERTAIN', cleanup_owner=self if self._handle is not None else None,
    ...
    def terminate(self) -> None:
        with self._lock:
            ...
            try:
                ...
                raise self._failure('TERMINATE', error) from error
    ...
    try:
        ...
        if owner._handle is None:
            ...
            try:
                ...
                pass  # HOLDS and failure.cleanup_owner retain the native owner.
            if owner.closed:
