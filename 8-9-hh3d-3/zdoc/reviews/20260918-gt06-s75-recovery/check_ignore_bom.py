...
root = n.STUDIO / '.local/reviews/gt06-s75-ignore-bom-01'
...
config.write_bytes(b'\xef\xbb\xbf' + raw)
...
n.write(root / 'result.json', {'guard_rejected': True, 'formal_acceptance': False,
    ...
    'negative_exit_scan_warning_preserved': bool(stderr), 'capture_sha256': n.sha((root / 'editor-host/capture.json').read_bytes())})
