...
const DIAGNOSTIC_DIRECTORY: String = "D:/dataDiskD/intellji/hoanhaosocial/hoanhaonew-20-6-2025/hh-game-studio/8-9-hh3d-3/studio/.local/reviews/gt06-s75-editor-files-indexed-01/census"
