...
SOURCE = Path(os.environ['HH_S49_FROZEN_STUDIO']).resolve()
sys.path.insert(0, str(SOURCE.parent))
spec = importlib.util.spec_from_file_location('s49_final_executor', SOURCE / 'godot-addon/linux_executor.py')
...
def main(root):
    ...
    try:
        ...
        evidence['child_body_observed']=b'S49_IDLE_BODY_AFTER_HOST_DEATH' in observer[0][1]
