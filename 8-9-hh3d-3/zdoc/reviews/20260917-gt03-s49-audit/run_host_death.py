"""Capture the independent host-death diagnostic with the final S49 closure."""
...
FROZEN = AUDIT.parent / '20260917-gt03-s49-editor-01' / 'source' / 'studio'
OUTPUT = AUDIT.parent / '20260917-gt03-s49-host-death-01'
...
def main():
    ...
    spec = importlib.util.spec_from_file_location('s49_host_death_owned', runner_path)
    ...
    env = dict(os.environ)
    env['HH_S49_FROZEN_STUDIO'] = str(FROZEN)
