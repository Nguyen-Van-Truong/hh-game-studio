...
def _operation_descriptor(operation: str) -> dict[str, Any]:
    ...
    return {
        ...
        "diff_supported": True,
        "diff_policy": ("observed received-JCS before/after; native revisions remain opaque" if edit else
                        "planned immutable bundle creation; exact hashes require completed publication"),
        "affected_files": (
