...
$name = 'HHStudio.GT06.gt06-s79-object-diagnostic-01'
...
if ($Command -eq 'run') {
    if ($null -ne $task -or (Test-Path -LiteralPath (Join-Path $PSScriptRoot 'object-owner-01'))) { throw 'DIAGNOSTIC_ALREADY_EXISTS' }
    ...
    $definition.Settings.ExecutionTimeLimit = 'PT14M'
