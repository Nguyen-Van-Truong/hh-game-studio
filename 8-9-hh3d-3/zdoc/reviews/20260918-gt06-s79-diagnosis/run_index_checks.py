...
ROOT = BASE.parents[2]
OUTPUT = BASE / 'index-checks-01'
MODULES = [
    'studio.tests.protocol.test_journal',
    'studio.tests.protocol.test_journal_cas',
    'studio.tests.protocol.test_journal_durability',
    'studio.tests.protocol.test_journal_platform',
    'studio.tests.protocol.test_journal_retention',
    'studio.tests.replay.test_benchmark_commands',
    'studio.tests.replay.test_service',
    'studio.tests.replay.test_disk_journal_index',
    'studio.tests.replay.test_verified_journal',
    'studio.tests.replay.test_index_faults',
]
...
def main():
    ...
    paths += ['studio/tests/replay/test_index_faults.py']
    ...
    spec = importlib.util.spec_from_file_location('s79_owned', runner)
    ...
    code = ('import unittest,json,sys; names=' + repr(MODULES) + '; '
            ...
            'print("S79_INDEX_CHECKS "+json.dumps({"run":r.testsRun,"failures":len(r.failures),'
