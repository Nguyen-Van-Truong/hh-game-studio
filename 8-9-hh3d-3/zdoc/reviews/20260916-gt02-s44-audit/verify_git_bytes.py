"""Verify frozen source and S44 evidence against an index or commit tree."""
import hashlib
import json
...
source = json.loads(git_bytes('zdoc/reviews/20260916-gt02-s44-02/source-closure.json'))
rows = []
...
checked = []
for folder in ('20260916-gt02-s44-02', '20260916-gt02-s44-native', '20260916-gt02-s44-boundary', '20260916-gt02-s44-diagnostics', '20260916-gt02-s44-01', '20260916-gt02-s44-audit'):
