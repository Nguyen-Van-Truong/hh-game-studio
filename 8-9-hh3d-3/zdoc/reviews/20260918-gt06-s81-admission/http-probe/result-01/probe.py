...
def main():
    ...
    need(hasattr(transport.FixtureClient, 'last_transport_failure'), 'FAILURE_DIAGNOSTICS_REQUIRED')
    ...
    actual_dispatch = transport.LoopbackFixtureHost._dispatch
    actual_disconnect = transport.LoopbackFixtureHost._disconnect_probe
    actual_send = transport.LoopbackFixtureHost._send
    ...
    try:
        with ExitStack() as stack:
            for target, name, replacement in (
                ...
                (transport.LoopbackFixtureHost, '_dispatch', dispatch),
                (transport.LoopbackFixtureHost, '_disconnect_probe', disconnect),
                (transport.LoopbackFixtureHost, '_send', send)):
