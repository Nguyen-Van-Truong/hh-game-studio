...
def main():
    ...
    paths += ['studio/tests/protocol/test_transport_observation.py']
    ...
    code = ('import unittest,json,sys; names=' + repr(MODULES) + '; '
            ...
            'print("S81_TRANSPORT_CHECKS "+json.dumps({"run":r.testsRun,"failures":len(r.failures),'
