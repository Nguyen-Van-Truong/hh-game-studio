...
class ReconciliationAuthorityTests(unittest.TestCase):
    def setUp(self):
        ...
        self.owner._inspection=lambda command_id,digest:(self.owner._journal.snapshot(),
            self.owner._journal.lookup(command_id,digest),None,copy.deepcopy(self.context))
