...
class ContractTests(unittest.TestCase):
    ...
    def test_catalog_revision_contract_and_digest_change_without_runtime_enablement(self):
        ...
        self.assertEqual(catalog['catalog_version'],'gt03-godot-5')
        self.assertEqual(catalog['managed_edit_policy']['effect_scope'],'editor_session')
        self.assertIs(catalog['managed_edit_policy']['files_saved'],False)
        self.assertIs(catalog['managed_edit_policy']['live_state_durable'],False)
