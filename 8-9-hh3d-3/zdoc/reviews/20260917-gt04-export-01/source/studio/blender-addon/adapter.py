...
class FixtureAdapter:
    ...
    def _objects(self):
        ...
        if (len(bpy.data.scenes) != 1 or len(bpy.data.objects) > contract.MAX_OBJECTS or
                ...
                bpy.data.actions or bpy.data.materials or bpy.data.images or bpy.data.worlds):
        ...
        for obj in bpy.data.objects:
            ...
            if (stable_id in result or obj.type != "MESH" or obj.library or obj.data.library or
                    ...
                    obj.data.animation_data or obj.data.shape_keys or obj.data.materials or
    ...
    def execute(self, raw):
        ...
        if operation == "object.transform.set" and stable_id not in objects:
