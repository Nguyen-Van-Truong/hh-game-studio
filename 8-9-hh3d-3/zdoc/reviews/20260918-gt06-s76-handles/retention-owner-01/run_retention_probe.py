...
out=base/'retention-owner-01';out.mkdir(exist_ok=False)
files=['pss_handles.py','diagnose_retention.py','run_retention_probe.py']
...
executable=Path(sys.executable).with_name('python.exe');assert executable.is_file()
argv=[str(executable),'-B',str(base/'diagnose_retention.py')]
