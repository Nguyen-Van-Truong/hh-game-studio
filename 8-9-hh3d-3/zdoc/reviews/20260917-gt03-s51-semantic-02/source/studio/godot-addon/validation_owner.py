...
class ValidationOwner:
        ...
        try:
            ...
            try:
                ...
                self._records[command_id] = _Record(bundle, directory, raw_observation, evidence,
                                                   dict(self._source_files), receipt, time.time_ns() // 1_000_000)
                return receipt
            except BaseException:
                self._held = True
                raise
    ...
    def bind_semantics(self, receipt, bundle):
        ...
        try:
            ...
            value = SemanticValidationReceipt(receipt.command_id, final.project_revision, revision,
                _sha(final.manifest_bytes), input_hash, receipt.source_release_sha256,
                receipt.engine_sha256, receipt.observation_sha256, receipt.evidence_sha256,
                receipt.run_id, original.completed_ms)
    ...
    def semantic_observation(self, receipt, bundle):
        ...
        try:
            ...
            return {'context_kind': 'isolated_candidate', 'command_id': receipt.command_id,
                'run_id': receipt.run_id, 'observed_ms': receipt.observed_ms,
