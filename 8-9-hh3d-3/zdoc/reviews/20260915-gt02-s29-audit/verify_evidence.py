...
PACK = ROOT / 'zdoc/reviews/20260915-gt02-s29-01'
STUDIO = ROOT / 'studio'
...
def verify():
    ...
    mapping = {
        ...
        'P-13': ['capacity_reserves_terminal_record_and_bytes_before_mutation', 'reopen_and_compaction_stream_receipts_with_bounded_memory'],
        ...
        'P-17': ['no_exec_primitives_in_validation_modules', 'semantic_scope_identity_hash_and_deadline_rejections_have_no_effect'],
        ...
        'P-19': ['pending_ack_socket_cuts_preserve_lookup_and_one_effect', 'committed_lookup_ack_socket_cuts_return_original_receipt', 'cancel_ack_socket_cuts_do_not_duplicate_or_apply', 'stop_ack_socket_cuts_preserve_stopped_state_on_reconnect'],
    ...
    return {'schema': 'hh-gt02-solo-verification-v1', 'status': 'COORDINATOR_LOGIC_VERIFIED',
