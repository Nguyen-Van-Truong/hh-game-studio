"""Verify frozen source and S45 evidence against an index or commit tree."""
import hashlib
import json
...
source = json.loads(git_bytes('zdoc/reviews/20260916-gt02-s45-02/source-closure.json'))
rows = []
...
checked = []
for folder in ('20260916-gt02-s45-02','20260916-gt02-s45-registry-native','20260916-gt02-s45-admission-01','20260916-gt02-s45-custody','20260916-gt02-s45-event-custody','20260916-gt02-s45-managed-01','20260916-gt02-s45-managed-02','20260916-gt02-s45-lease-regression','20260916-gt02-s45-01','20260916-gt02-s45-audit'):
