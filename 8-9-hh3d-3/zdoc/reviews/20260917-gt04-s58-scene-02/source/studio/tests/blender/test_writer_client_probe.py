...
def child():
    return {"passed": True, "publication_profile": "export.publish", "pid": 303, "checks": rows(probe.CLIENT_CHECKS), "public_ack": False,
...
class NativeArtifacts(unittest.TestCase):
    def setUp(self):
        ...
        self.manifest = {"publication_profile": "export.publish", "run_id": "writer-test", "source_closure_sha256": "b" * 64}
        self.report = {
    ...
    def test_wrong_source_claims_path_or_duplicate_native_completion_rejected(self):
        ...
        for changes in ({"source_closure_sha256": "c" * 64}, {"run_id": "other-run"},
                        {'publication_profile': 'scene.save'}, {'publication_profile': None},
