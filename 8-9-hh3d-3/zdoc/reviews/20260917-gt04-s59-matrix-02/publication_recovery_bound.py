"""S59 bound native crash/Stop supplement over unchanged frozen runtime.
...
def setup(output,binary):
    ...
    from studio.protocol.core import canonical_bytes
    verify()
    need(source_files()==_execution_binding['runtime_files'] and model.sha(canonical_bytes(source_files()))==RUNTIME_SHA256,'S59 complete runtime binding changed')
