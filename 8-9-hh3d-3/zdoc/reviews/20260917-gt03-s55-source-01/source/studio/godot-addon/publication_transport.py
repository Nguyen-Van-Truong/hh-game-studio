"""Bounded work, lookup/control and canonical Stop-only loopback listeners.
...
class PublicationTransport:
    ...
    work_routes = {'/v1/discovery':'discover', '/v1/lease':'lease', '/v1/commands':'submit',
        '/v1/lease/enqueue':'lease_enqueue','/v1/lease/poll':'lease_poll','/v1/lease/cancel':'lease_cancel'}
    ...
    def _handle(self, stream, listener):
        ...
        try:
            ...
            if listener is self._control and path == '/v1/lookup':
                ...
                if not lookup_owned:
                    raise SafetyViolation('GODOT_LOOKUP_BUSY')
