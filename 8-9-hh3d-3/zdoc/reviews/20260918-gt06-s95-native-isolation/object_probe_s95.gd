...
func _s95_before_batch() -> void:
    if _mode != "diagnostic" or _s95_snapshot_count >= S95_SNAPSHOT_CAP:
        return
    ...
    var point: Dictionary = {
        "schema_id": "hh-studio.gt06.s95-sparse-attribution", "schema_version": "1.0.0",
        "run_id": _input.run_id, "pid": OS.get_process_id(), "batch": _batch,
        "sequence": _s95_snapshot_count, "phase": "before_batch_counter_readback",
    ...
    var post: Dictionary = _write_new("sparse-post-%02d.json" % _s95_snapshot_count, {
        "schema_id": "hh-studio.gt06.s95-sparse-post", "schema_version": "1.0.0",
        "run_id": _input.run_id, "batch": _batch, "sequence": _s95_snapshot_count,
