...
- Benchmark projection is 53 files; installed execution projection is 215 declared plus 2 metadata files. They are intentional distinct scopes: 39 names overlap, 14 are benchmark-only, current union 231. G2 is missing a final freeze binding both projections to generated input/runtime artifacts, profile, toolchain, driver and verifier.
