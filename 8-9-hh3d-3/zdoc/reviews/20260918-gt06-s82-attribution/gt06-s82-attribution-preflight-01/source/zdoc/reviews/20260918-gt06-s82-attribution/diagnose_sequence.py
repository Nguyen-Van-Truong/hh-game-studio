"""One disposable S82 HTTP/native sequence with sparse object attribution.
...
RUN_ID = 'gt06-s82-attribution-01'
PREFLIGHT_ID = 'gt06-s82-attribution-preflight-01'
...
def install_prepare(c, output):
    ...
    def prepared(project, factory, trusted, binding):
        ...
        c.write(output / 'native-overlay.json', {
            ...
            'scope': 'partial reachable inventory; collection overhead affects timing and RSS'})
