...
const TEST_DIR: String = ".hh-agent/r6w6"
const TEST_FIXTURE_DIR: String = "r6w6"
const TEST_SCHEMA: String = "hh-test/1"
const TEST_WAIT_MS: int = 90000
const TEST_RETENTION_HOURS: int = 24
const REPAIR_DIR: String = ".hh-agent/r6w7"
const REPAIR_FIXTURE_DIR: String = "r6w7"
