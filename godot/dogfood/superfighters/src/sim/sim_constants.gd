...
const MATCH_PATH: String = "res://data/sim/match.json"
const STAGE_PATH: String = "res://data/sim/stage.json"
const SURVIVAL_PATH: String = "res://data/sim/survival.json"
const BOTS_PATH: String = "res://data/sim/bots.json"
const MATCH_TRACE_DIR: String = "res://tests/traces/match"
