...
declare pit/fall. Signal Court also declares rotor because VF5-WP4
places a shootable machine. Water/toxic stay on fixtures.
...
Live hazardous paints `c`/`b` as tiles from prop/hazard layers
