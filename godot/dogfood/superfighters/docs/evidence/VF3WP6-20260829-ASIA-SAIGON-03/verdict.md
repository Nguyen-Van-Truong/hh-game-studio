...
- SCHEMA=pass BATCH=pass DIST=pass DOM=pass MELEE=pass HIGH=pass OVERCAP=pass PIT=pass CHAIN=pass FF=pass STAMINA=pass DATA=pass LIVE=pass REPLAY=match
- BATCH count=1000 replay=True real=True
- DIST n=11000 mean=24.3387363546545 p95=42.0 real=True
- DOM leader=knife rate=0.406 winners=4 contexts=3 live=3 method=formula_rolls real=True
- MELEE damage=10.0 real=True
- HIGH damage=18.0 real=True
- OVERCAP path=bullet spawn=90.0 raw=90.0 applied=56.0 real=True
...
- `USED_APPLY_FRAMES=1052` attempted=1052
- source_tree_sha256 `9a42744a3b53c3e45c2b9bd5749dd3e640b1ba506bdf265bf26ae13a8d610526`
