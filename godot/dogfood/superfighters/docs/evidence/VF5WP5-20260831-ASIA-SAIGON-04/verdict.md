...
- `run_id`: `VF5WP5-20260831-ASIA-SAIGON-04`
- `command_id`: `cmd.vf5-wp5.vitriol-sump.5`
...
- DIVE dived=True acid=False
- ROLL rolled=True acid=True
- CARGO hung_after=False drops=1 real=True
- TACTIC floor_dead=True pipe_alive=True real=True
...
- still errors: []
- `USED_APPLY_FRAMES=5394` attempted=5394
- source_tree_sha256 `793f84bf116da3064651b0b6465168d348b965476b47dfa6c69c34f1dd85edce`
...
$godot --path godot/dogfood/superfighters --script res://tests/run_sewer.gd
