...
- `run_id`: `VF3WP5-20260829-ASIA-SAIGON-01`
- `command_id`: `cmd.vf3-wp5.roster.1`
...
- SPAWN spawned=10 expected=10 real=True
- ATTACK attacked=11 expected=11 real=True
- KEEP melee=True nade=True power=True real=True
- SERIALIZE firearm=rifle real=True
- AMMO empty=True reload=True real=True
- events kinds include pickup/fire/throw=True
- window screenshot=True
- `USED_APPLY_FRAMES=474` attempted=474
- source_tree_sha256 `a763e9faa655ecb0e236e9110ddd134afdb2f0fa7a67e4b534ef108d89f9f4da`
