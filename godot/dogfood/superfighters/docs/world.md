...
Live `c`/`b` stay painted tiles (VF5-WP1 prop/hazard layers).
VF5-WP2 places original breakable cover on Skyline Relay
(`docs/rooftop.md`). VF5-WP3 places original cover, hanging cargo,
