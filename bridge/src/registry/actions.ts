...
const SPECS: Record<string, ActionSpec> = {
  ...
  "tilemap.tileset": mutate(
    ...
    obj(["scene", "node_path", "tileset"], {
      ...
      node_path: NODE_PATH,
      tileset: RES_PATH,
      op: { type: "string", enum: ["assign", "create", "configure"] },
      tile_size: INDEX,
      physics_layers: INDEX,
      navigation_layers: INDEX,
      occlusion_layers: INDEX,
    }),
    {
      scene: "res://scenes/world.tscn",
  ...
  "tilemap.source": mutate(
    ...
    obj(["tileset", "source_id", "texture"], {
      ...
      source_id: INDEX,
      texture: RES_PATH,
      op: { type: "string", enum: ["add", "configure", "remove"] },
      texture_region_size: INDEX,
      create_tiles: BOOL,
      collision: BOOL,
    }),
  ...
  "tilemap.terrain": mutate(
    ...
    "editor_undo_redo",
    "terrain_set_present",
    obj(["tileset", "terrain_name"], {
      tileset: RES_PATH,
      terrain_name: IDENT,
      op: { type: "string", enum: ["add", "configure", "connect"] },
      terrain_set: INDEX,
      scene: RES_PATH,
      node_path: NODE_PATH,
      cells: {
  ...
  "tilemap.layer": mutate(
    ...
    obj(["scene", "node_path", "enabled"], {
      ...
      node_path: NODE_PATH,
      enabled: BOOL,
      op: { type: "string", enum: ["configure", "add", "remove", "reorder"] },
      name: IDENT,
      parent: NODE_PATH,
      index: INDEX,
    }),
  ...
  "ui.control": mutate(
    ...
    obj(["scene", "node_path", "preset"], {
      ...
      size_flags_horizontal: { type: "integer", minimum: 0, maximum: 15 },
      size_flags_vertical: { type: "integer", minimum: 0, maximum: 15 },
      stretch_ratio: { type: "number", minimum: 0, maximum: 64 },
      grow_horizontal: { type: "integer", minimum: 0, maximum: 2 },
      grow_vertical: { type: "integer", minimum: 0, maximum: 2 },
      custom_minimum_size: obj(["x", "y"], {
      ...
      offset_left: { type: "number", minimum: -16384, maximum: 16384 },
      offset_top: { type: "number", minimum: -16384, maximum: 16384 },
      offset_right: { type: "number", minimum: -16384, maximum: 16384 },
      offset_bottom: { type: "number", minimum: -16384, maximum: 16384 },
      clip_contents: BOOL,
    }),
  ...
  "ui.theme": mutate(
    ...
    obj(["scene", "node_path", "theme"], {
      ...
      styleboxes: {
        type: "array",
        maxItems: 32,
        items: obj(["name", "theme_type", "resource"], {
          name: IDENT,
          theme_type: IDENT,
          resource: RES_PATH,
        }),
      ...
      font_sizes: {
        type: "array",
        maxItems: 32,
        items: obj(["name", "theme_type", "size"], {
          name: IDENT,
          theme_type: IDENT,
      ...
      colors: {
        type: "array",
        maxItems: 32,
        items: obj(["name", "theme_type", "color"], {
          name: IDENT,
          theme_type: IDENT,
          color: VARIANT,
        }),
      ...
      constants: {
        type: "array",
        maxItems: 32,
        items: obj(["name", "theme_type", "value"], {
          name: IDENT,
          theme_type: IDENT,
          value: { type: "integer", minimum: -4096, maximum: 4096 },
        }),
      },
      overrides: {
        type: "array",
        ...
        items: obj(["kind", "name"], {
          kind: {
            type: "string",
            enum: ["stylebox", "font", "font_size", "color", "constant"],
          },
          name: IDENT,
          resource: RES_PATH,
          value: { type: "integer", minimum: -4096, maximum: 4096 },
  ...
  "ui.layout": mutate(
    ...
    obj(["scene", "node_path", "separation"], {
      ...
      margin_left: { type: "integer", minimum: 0, maximum: 256 },
      margin_top: { type: "integer", minimum: 0, maximum: 256 },
      margin_right: { type: "integer", minimum: 0, maximum: 256 },
      margin_bottom: { type: "integer", minimum: 0, maximum: 256 },
      viewport_size: obj(["x", "y"], {
        x: { type: "integer", minimum: 1, maximum: 8192 },
        y: { type: "integer", minimum: 1, maximum: 8192 },
      }),
      clip_contents: BOOL,
      children: {
        type: "array",
  ...
  "ui.anchor": mutate(
    ...
    obj(["scene", "node_path", "anchor_left", "anchor_top"], {
      ...
      anchor_right: { type: "number", minimum: 0, maximum: 1 },
      anchor_bottom: { type: "number", minimum: 0, maximum: 1 },
      offset_left: { type: "number", minimum: -16384, maximum: 16384 },
      offset_top: { type: "number", minimum: -16384, maximum: 16384 },
      offset_right: { type: "number", minimum: -16384, maximum: 16384 },
      offset_bottom: { type: "number", minimum: -16384, maximum: 16384 },
  ...
  "audio.player": mutate(
    "Assign AudioStreamGenerator + bus/volume on AudioStreamPlayer/2D (editor; not heard SFX)",
    "editor_undo_redo",
    "audio_player_stream_bus_matches",
    obj(["scene", "node_path"], {
      scene: RES_PATH,
      node_path: NODE_PATH,
      stream: RES_PATH,
      bus: { type: "string", minLength: 1, maxLength: 64 },
      volume_db: { type: "number", minimum: -80, maximum: 24 },
    }),
    {
      scene: "res://scenes/world.tscn",
      node_path: "SFX",
      stream: "res://audio/gen.tres",
      bus: "SFX",
      volume_db: -6,
    },
    { extra_errors: SCENE_MUTATE_ERRORS },
  ...
  "audio.bus": mutate(
    "Configure AudioServer bus mute/volume and persist AudioBusLayout",
    "editor_undo_redo",
    "audio_bus_layout_matches",
    obj(["bus"], {
      bus: { type: "string", minLength: 1, maxLength: 64 },
      mute: BOOL,
      volume_db: { type: "number", minimum: -80, maximum: 24 },
      send: { type: "string", minLength: 1, maxLength: 64 },
      add: BOOL,
      isolate: BOOL,
      restore: BOOL,
      layout: RES_PATH,
      restore_layout: RES_PATH,
      previous_layout: RES_PATH,
    }),
    { bus: "SFX", mute: false, volume_db: -6, layout: "res://audio/buses.tres" },
    { extra_errors: SCENE_MUTATE_ERRORS },
  ),
  "audio.preview": view(
    "Read editor audio player assignment; playing is not heard SFX",
    "audio_preview_editor_only",
    obj(["scene", "node_path"], { scene: RES_PATH, node_path: NODE_PATH }),
    { scene: "res://scenes/world.tscn", node_path: "SFX" },
  ),

  "render.shader": mutate(
    "Write/assign canvas_item shader + ShaderMaterial params (refuse silent-ok)",
    "editor_undo_redo",
    "render_shader_mode_uniforms_match",
    obj(["scene", "node_path"], {
      scene: RES_PATH,
      node_path: NODE_PATH,
      shader: RES_PATH,
      code: SCRIPT_TEXT,
      required_uniform: { type: "string", minLength: 1, maxLength: 64 },
      mode: { type: "string", enum: ["canvas_item"] },
      material: RES_PATH,
      parameters: {
        type: "object",
    ...
    }),
    {
      scene: "res://scenes/world.tscn",
      node_path: "Sprite",
      shader: "res://shaders/tint.gdshader",
      required_uniform: "tint",
      mode: "canvas_item",
    },
    { extra_errors: SCENE_MUTATE_ERRORS },
  ),
  "render.particles": mutate(
    "Configure GPUParticles2D amount/lifetime/process_material (engine AABB)",
    "editor_undo_redo",
    "render_particles_amount_lifetime_match",
    obj(["scene", "node_path"], {
      scene: RES_PATH,
      node_path: NODE_PATH,
      amount: { type: "integer", minimum: 1, maximum: 4096 },
      lifetime: { type: "number", minimum: 0.01, maximum: 64 },
      process_material: RES_PATH,
      texture: RES_PATH,
    }),
    {
      scene: "res://scenes/world.tscn",
  ...
  "render.quality": mutate(
    "Set 2D light/modulate/environment; Compatibility skips glow/volumetric honestly",
    "editor_undo_redo",
    "render_quality_readback_matches",
    obj(["scene", "node_path"], {
      scene: RES_PATH,
      node_path: NODE_PATH,
      energy: { type: "number", minimum: 0, maximum: 64 },
      color: obj(["r", "g", "b"], {
        r: { type: "number", minimum: 0, maximum: 16 },
        g: { type: "number", minimum: 0, maximum: 16 },
        b: { type: "number", minimum: 0, maximum: 16 },
        a: { type: "number", minimum: 0, maximum: 16 },
      }),
      shadow_enabled: BOOL,
      glow: BOOL,
      volumetric: BOOL,
      environment: RES_PATH,
      modulate: RES_PATH,
    }),
    {
      scene: "res://scenes/world.tscn",
  ...
  "review.card": read(
    ...
    obj(["detail"], {
      ...
      id: IDENT,
      reload: BOOL,
      press: { type: "string", enum: ["before", "after", "diff", "replay", "revert"] },
      command_id: { type: "string", minLength: 26, maxLength: 26 },
    }),
    { detail: "short" },
    "none",
  ...
  "review.write_card": read(
    "Write a milestone review card from params or last checkpoint + observer",
    "review_card_written",
    obj(["goal"], {
      goal: TEXT,
      auto: BOOL,
      ...
      before: TEXT,
      after: TEXT,
      diff_path: REVIEW_REL,
      checkpoint_id: { type: "string", minLength: 7, maxLength: 64, pattern: "^[A-Za-z0-9_./-]+$" },
    }),
    { goal: "Review latest checkpoint", auto: true },
    "none",
    { timeout_ms: 15_000 },
  ),
  "editor.select": view(
  ...
  "input.action": ext(
    ...
    obj(["action_name", "phase"], {
      ...
      device: INDEX,
      axis: INDEX,
      axis_value: { type: "number", minimum: -1, maximum: 1 },
      button_index: INDEX,
      editor_foreground: BOOL,
    }),
  ...
  "input.mouse": ext(
    ...
    obj(["button", "x", "y"], {
      ...
      phase: { type: "string", enum: ["press", "release", "motion"] },
      wheel: { type: "string", enum: ["up", "down"] },
      dx: { type: "number", minimum: -8192, maximum: 8192 },
      dy: { type: "number", minimum: -8192, maximum: 8192 },
      run_id: RUN_ID,
      editor_foreground: BOOL,
    }),
    ...
    obj(["steps"], {
      steps: {
        ...
        items: obj(["action_name", "phase"], {
          ...
          delay_ticks: { type: "integer", minimum: 0, maximum: 120 },
        }),
      },
      run_id: RUN_ID,
      replay: BOOL,
  ...
  "input.release_all": ext(
    ...
    obj(["scope"], {
      scope: { type: "string", enum: ["all", "keyboard", "mouse"] },
      run_id: RUN_ID,
    }),
    { scope: "all" },
    "job_supervisor",
  ...
  "runtime.freeze": ext(
    ...
    obj(["frozen", "reason"], {
      ...
      seed: { type: "integer", minimum: 0, maximum: 2147483647 },
      physics_ticks: { type: "integer", minimum: 1, maximum: 240 },
      frame: { type: "integer", minimum: 0, maximum: 0 },
      run_id: RUN_ID,
    }),
  ...
  "runtime.step": ext(
    ...
    obj(["frames"], {
      ...
      ms: { type: "integer", minimum: 1, maximum: 10000 },
      timeout_ms: { type: "integer", minimum: 50, maximum: 30000 },
      until: obj(["key", "op"], {
        key: IDENT,
        op: { type: "string", enum: ["eq", "neq", "gt", "gte", "lt", "lte"] },
        node_path: NODE_PATH,
        value_int: { type: "integer", minimum: -2147483648, maximum: 2147483647 },
        value_bool: BOOL,
        value_string: { type: "string", minLength: 0, maxLength: 128 },
      }),
      seed: { type: "integer", minimum: 0, maximum: 2147483647 },
      run_id: RUN_ID,
    }),
  ...
  "runtime.screenshot": ext(
    "Capture a Play game viewport screenshot",
    "screenshot_artifact_present",
    obj(["scale"], {
      scale: { type: "number", minimum: 0.25, maximum: 2 },
      target: { type: "string", enum: ["game", "editor"] },
      stable_frames: { type: "integer", minimum: 1, maximum: 30 },
      region_x: { type: "integer", minimum: 0, maximum: 8192 },
      region_y: { type: "integer", minimum: 0, maximum: 8192 },
      region_w: { type: "integer", minimum: 1, maximum: 8192 },
      region_h: { type: "integer", minimum: 1, maximum: 8192 },
      mask_x: { type: "integer", minimum: 0, maximum: 8192 },
      mask_y: { type: "integer", minimum: 0, maximum: 8192 },
      mask_w: { type: "integer", minimum: 1, maximum: 8192 },
      mask_h: { type: "integer", minimum: 1, maximum: 8192 },
  ...
  "runtime.perf": ext(
    "Sample Play perf counters and a hardware manifest",
    "perf_counters_present",
    obj(["detail"], {
      detail: DETAIL,
      warmup_frames: { type: "integer", minimum: 0, maximum: 120 },
  ...
  "runtime.assert": read(
    "Evaluate a Play-proven state assertion (not a screenshot-only pass)",
    "assertion_evaluated",
    obj(["kind"], {
      kind: {
        type: "string",
        enum: ["tree", "property", "signal", "ui_layout", "audio_event", "world"],
      },
      node_path: NODE_PATH,
      key: IDENT,
      op: { type: "string", enum: ["eq", "neq", "gt", "gte", "lt", "lte", "exists"] },
      value_int: { type: "integer", minimum: -2147483648, maximum: 2147483647 },
      value_bool: BOOL,
      value_string: { type: "string", minLength: 0, maxLength: 128 },
      signal: IDENT,
    ...
    { kind: "property", node_path: "Fixture", key: "panel_color", op: "eq", value_string: "pass_red" },
    "none",
    { timeout_ms: 15_000 },
  ),
  ...
  "test.define": mutate(
    ...
    obj(["name", "steps"], {
      ...
      suite: IDENT,
      path: RES_PATH,
      filter: { type: "array", minItems: 1, maxItems: 32, items: IDENT },
      retry_max: { type: "integer", minimum: 0, maximum: 3 },
      flaky_is_not_pass: BOOL,
      scene: RES_PATH,
      mode: { type: "string", enum: ["play", "debug"] },
      timeout_ms: { type: "integer", minimum: 100, maximum: 120000 },
      step_frames: { type: "integer", minimum: 1, maximum: 240 },
      step_timeout_ms: { type: "integer", minimum: 50, maximum: 30000 },
      until_key: IDENT,
      until_op: { type: "string", enum: ["eq", "neq", "gt", "gte", "lt", "lte"] },
      until_value_bool: BOOL,
      until_value_int: { type: "integer", minimum: -2147483648, maximum: 2147483647 },
      until_value_string: { type: "string", minLength: 0, maxLength: 128 },
      assert_kind: {
        type: "string",
        enum: ["tree", "property", "signal", "ui_layout", "audio_event", "world"],
      },
      assert_node_path: NODE_PATH,
      assert_key: IDENT,
      assert_op: { type: "string", enum: ["eq", "neq", "gt", "gte", "lt", "lte", "exists"] },
      assert_value_string: { type: "string", minLength: 0, maxLength: 128 },
      assert_value_int: { type: "integer", minimum: -2147483648, maximum: 2147483647 },
      assert_value_bool: BOOL,
      assert_signal: IDENT,
      input_action: IDENT,
      input_phase: { type: "string", enum: ["press", "release"] },
      visual_compare: BOOL,
      visual_baseline: IDENT,
      visual_update_baseline: BOOL,
      visual_reviewed: BOOL,
      perf_budget_ms: { type: "integer", minimum: 1, maximum: 10000 },
      perf_inject_spike: BOOL,
      teardown_stop: BOOL,
    }),
  ...
  "test.run": ext(
    ...
    { name: "pickup_key" },
    "job_supervisor",
    { extra_errors: [E.E_TIMEOUT, E.E_BUSY, E.E_CONFLICT, E.E_PATH] },
  ),
  "test.assert": mutate(
  ...
  "test.report": read(
    ...
    "test_report_present",
    obj(["name"], { name: IDENT, path: RES_PATH }),
    { name: "pickup_key" },
  ),
  "test.evidence": read(
  ...
  "job.run": mutate(
    "Start or resume the orchestrator state machine (inspect→plan→checkpoint→execute→verify→repair)",
    "job_supervisor",
    ...
    obj(["job_id"], {
      ...
      path: RES_PATH,
      run_id: RUN_ID,
      fixture: { type: "string", enum: ["ok_slice", "infinite_repair", "dep_fail"] },
      hold_after: {
        type: "string",
        enum: [
          "inspect",
      ...
      resume: BOOL,
      inject_illegal: BOOL,
      fail_task: { type: "string", minLength: 1, maxLength: 64, pattern: "^[A-Za-z0-9_-]+$" },
      budgets: obj([], {
        commands: { type: "integer", minimum: 1, maximum: 10_000 },
        wall_ms: { type: "integer", minimum: 1, maximum: 3_600_000 },
        retries: { type: "integer", minimum: 0, maximum: 64 },
        context_tokens: { type: "integer", minimum: 256, maximum: 2_000_000 },
      }),
    }),
  ...
  "job.compact": mutate(
    "Compact host/orchestrator context into a jailed r7w5 state resource (session://state)",
    "job_supervisor",
    "soak_state_compacted",
    obj(["job_id"], {
      job_id: JOB_ID,
      op: { type: "string", enum: ["compact", "note", "wake", "rotate"] },
      session_id: RUN_ID,
      task_id: RUN_ID,
      command_id: RUN_ID,
      brief: TEXT,
      context_summary: TEXT,
      phase: { type: "string", enum: ["running", "idle", "done", "blocked"] },
      blocked_reason: TEXT,
      project_hash: HASH,
      scene_hash: HASH,
      version_pin: TEXT,
      ...
      progress: obj([], {
        applied: { type: "integer", minimum: 0, maximum: 100_000 },
        play_runs: { type: "integer", minimum: 0, maximum: 10_000 },
        next_step: { type: "integer", minimum: 0, maximum: 100_000 },
        restarts: obj([], {
          sidecar: { type: "integer", minimum: 0, maximum: 64 },
          editor: { type: "integer", minimum: 0, maximum: 64 },
          host: { type: "integer", minimum: 0, maximum: 64 },
        }),
      }),
    }),
    { job_id: "r7w5-demo", op: "compact", brief: "soak corpus" },
    { extra_errors: [E.E_PAUSED, E.E_POLICY, E.E_PATH], timeout_ms: 15_000, cancel: true },
  ),
  "job.schedule": mutate(
